...
public class TabloidDbContext : IdentityDbContext<IdentityUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            new Post { Id = 1, UserProfileId = 1, CategoryId = 1, IsApproved = true, Title = "Post 1", Content = "Content 1", HeaderImageURL = "https://www.freewebheaders.com/wp-content/gallery/funny/funny-kittens-and-cold-day-website-header.jpg", PublicationDate = DateTime.Now.AddDays(-2) },
            new Post { Id = 2, UserProfileId = 1, CategoryId = 2, IsApproved = true, Title = "Post 2", Content = "Content 2", HeaderImageURL = "https://www.freewebheaders.com/wp-content/gallery/funny/cache/funny-dog-looking-out-the-car-window-web-header.jpg-nggid044570-ngg0dyn-1280x375x100-00f0w010c010r110f110r010t010.jpg", PublicationDate = DateTime.Now.AddDays(-1) },
            new Post { Id = 3, UserProfileId = 2, CategoryId = 1, IsApproved = true, Title = "Post 3", Content = "Content 3", HeaderImageURL = "https://www.freewebheaders.com/wp-content/gallery/funny/funny-kittens-and-cold-day-website-header.jpg", PublicationDate = DateTime.Now.AddDays(-4) },
            new Post { Id = 4, UserProfileId = 2, CategoryId = 3, IsApproved = true, Title = "Post 4", Content = "Content 4", HeaderImageURL = null, PublicationDate = DateTime.Now.AddDays(-1) },
            new Post { Id = 5, UserProfileId = 3, CategoryId = 2, IsApproved = true, Title = "Post 5", Content = "Content 5", HeaderImageURL = "https://www.freewebheaders.com/wp-content/gallery/funny/funny-kittens-and-cold-day-website-header.jpg", PublicationDate = DateTime.Now.AddDays(-2) },
            new Post { Id = 6, UserProfileId = 3, CategoryId = 3, IsApproved = true, Title = "Post 6", Content = "Content 6", HeaderImageURL = "https://www.freewebheaders.com/wp-content/gallery/funny/funny-kittens-and-cold-day-website-header.jpg", PublicationDate = DateTime.Now.AddDays(-2) },
            new Post { Id = 7, UserProfileId = 4, CategoryId = 4, IsApproved = true, Title = "Post 7", Content = "Content 7", HeaderImageURL = null, PublicationDate = DateTime.Now.AddDays(-3) },
            ...
            new Post { Id = 9, UserProfileId = 5, CategoryId = 2, IsApproved = true, Title = "Post 9", Content = "Content 9", HeaderImageURL = "https://www.freewebheaders.com/wp-content/gallery/funny/funny-kittens-and-cold-day-website-header.jpg", PublicationDate = DateTime.Now.AddDays(-5) },
            new Post { Id = 10, UserProfileId = 5, CategoryId = 4, IsApproved = false, Title = "Post 10", Content = "Content 10", HeaderImageURL = null, PublicationDate = DateTime.Now.AddDays(-2) },
            new Post { Id = 11, UserProfileId = 6, CategoryId = 3, IsApproved = true, Title = "Post 11", Content = "Content 11", HeaderImageURL = null, PublicationDate = DateTime.Now.AddDays(-3) },
            new Post { Id = 12, UserProfileId = 6, CategoryId = 4, IsApproved = true, Title = "Post 12", Content = "Content 12", HeaderImageURL = null, PublicationDate = DateTime.Now },
            new Post { Id = 13, UserProfileId = 1, CategoryId = 1, IsApproved = false, Title = "Post 13", Content = "Content 13", HeaderImageURL = "https://www.freewebheaders.com/wp-content/gallery/funny/funny-kittens-and-cold-day-website-header.jpg", PublicationDate = DateTime.Now },
            new Post { Id = 14, UserProfileId = 2, CategoryId = 2, IsApproved = false, Title = "Post 14", Content = "Content 14", HeaderImageURL = "https://www.freewebheaders.com/wp-content/gallery/funny/cache/funny-dog-looking-out-the-car-window-web-header.jpg-nggid044570-ngg0dyn-1280x375x100-00f0w010c010r110f110r010t010.jpg", PublicationDate = DateTime.Now },
            new Post { Id = 15, UserProfileId = 3, CategoryId = 3, IsApproved = false, Title = "Post 15", Content = "Content 15", HeaderImageURL = null, PublicationDate = DateTime.Now }
        });

        modelBuilder.Entity<Comment>().HasData(new Comment[]
        {
            new Comment { Id = 1, UserProfileId = 1, PostId = 1, Content = "Comment 1" },
            new Comment { Id = 2, UserProfileId = 1, PostId = 2, Content = "Comment 2" },
            new Comment { Id = 3, UserProfileId = 2, PostId = 3, Content = "Comment 3" },
            new Comment { Id = 4, UserProfileId = 2, PostId = 4, Content = "Comment 4" },
            new Comment { Id = 5, UserProfileId = 3, PostId = 5, Content = "Comment 5" },
            new Comment { Id = 6, UserProfileId = 3, PostId = 6, Content = "Comment 6" },
            new Comment { Id = 7, UserProfileId = 4, PostId = 7, Content = "Comment 7" },
            new Comment { Id = 8, UserProfileId = 4, PostId = 8, Content = "Comment 8" },
            new Comment { Id = 9, UserProfileId = 5, PostId = 9, Content = "Comment 9" },
            new Comment { Id = 10, UserProfileId = 5, PostId = 10, Content = "Comment 10" },
            new Comment { Id = 11, UserProfileId = 6, PostId = 11, Content = "Comment 11" },
            new Comment { Id = 12, UserProfileId = 6, PostId = 12, Content = "Comment 12" },
            new Comment { Id = 13, UserProfileId = 1, PostId = 13, Content = "Comment 13" },
            new Comment { Id = 14, UserProfileId = 2, PostId = 14, Content = "Comment 14" },
            new Comment { Id = 15, UserProfileId = 3, PostId = 15, Content = "Comment 15" },
            new Comment { Id = 16, UserProfileId = 4, PostId = 1, Content = "Comment 16" },
            new Comment { Id = 17, UserProfileId = 5, PostId = 2, Content = "Comment 17" },
            new Comment { Id = 18, UserProfileId = 6, PostId = 3, Content = "Comment 18" },
            new Comment { Id = 19, UserProfileId = 1, PostId = 4, Content = "Comment 19" },
            new Comment { Id = 20, UserProfileId = 2, PostId = 5, Content = "Comment 20" }
        });
